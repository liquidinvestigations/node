...
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'azureinsights', false, '{"instrumentationKey":""}' ;
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'baidutongji', false, '{"propertyTrackingId":""}' ;
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'countly', false, '{"appKey":"","serverUrl":""}' ;
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'elasticapm', false, '{"serverUrl":"http://apm.example.com:8200","serviceName":"wiki-js","environment":""}' ;
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'fathom', false, '{"host":"","siteId":""}' ;
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'fullstory', false, '{"org":""}' ;
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'google', false, '{"propertyTrackingId":""}' ;
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'gtm', false, '{"containerTrackingId":""}' ;
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'hotjar', false, '{"siteId":""}' ;
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'matomo', false, '{"siteId":1,"serverHost":"https://example.matomo.cloud"}' ;
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'newrelic', false, '{"licenseKey":"","appId":"","beacon":"bam.nr-data.net","errorBeacon":"bam.nr-data.net"}' ;
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'plausible', false, '{"domain":"","plausibleJsSrc":"https://plausible.io/js/plausible.js"}' ;
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'statcounter', false, '{"projectId":"","securityToken":""}' ;
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'umami', false, '{"websiteID":"","url":""}' ;
INSERT INTO public.analytics (key, "isEnabled", config) SELECT 'yandex', false, '{"tagNumber":""}' ;
...
INSERT INTO public.authentication (key, "isEnabled", config, "selfRegistration", "domainWhitelist", "autoEnrollGroups", "order", "strategyKey", "displayName") SELECT 'liquid', true, '{"clientId":"XXX","clientSecret":"XXX","authorizationURL":"XXX","tokenURL":"XXX","userInfoURL":"XXX","userIdClaim":"XXX","displayNameClaim":"XXX","emailClaim":"XXX","mapGroups":true,"groupsClaim":"XXX","logoutURL":"XXX","scope":"read","useQueryStringForAccessToken":false,"enableCSRFProtection":true}', true, '{"v":[]}', '{"v":[2]}', 0, 'oauth2', 'XXX' ;
INSERT INTO public.authentication (key, "isEnabled", config, "selfRegistration", "domainWhitelist", "autoEnrollGroups", "order", "strategyKey", "displayName") SELECT 'local', true, '{}', false, '{"v":[]}', '{"v":[]}', 1, 'local', 'Local' ;
...
INSERT INTO public."commentProviders" (key, "isEnabled", config) SELECT 'artalk', false, '{"server":"","siteName":""}' ;
INSERT INTO public."commentProviders" (key, "isEnabled", config) SELECT 'commento', false, '{"instanceUrl":"https://cdn.commento.io"}' ;
INSERT INTO public."commentProviders" (key, "isEnabled", config) SELECT 'default', true, '{"akismet":"","minDelay":30}' ;
INSERT INTO public."commentProviders" (key, "isEnabled", config) SELECT 'disqus', false, '{"accountName":""}' ;
...
INSERT INTO public.editors (key, "isEnabled", config) SELECT 'api', false, '{}' ;
INSERT INTO public.editors (key, "isEnabled", config) SELECT 'asciidoc', false, '{}' ;
INSERT INTO public.editors (key, "isEnabled", config) SELECT 'ckeditor', false, '{}' ;
INSERT INTO public.editors (key, "isEnabled", config) SELECT 'code', false, '{}' ;
INSERT INTO public.editors (key, "isEnabled", config) SELECT 'markdown', true, '{}' ;
INSERT INTO public.editors (key, "isEnabled", config) SELECT 'redirect', false, '{}' ;
INSERT INTO public.editors (key, "isEnabled", config) SELECT 'wysiwyg', false, '{}' ;
...
INSERT INTO public.loggers (key, "isEnabled", level, config) SELECT 'airbrake', false, 'warn', '{}' ;
INSERT INTO public.loggers (key, "isEnabled", level, config) SELECT 'bugsnag', false, 'warn', '{"key":""}' ;
INSERT INTO public.loggers (key, "isEnabled", level, config) SELECT 'disk', false, 'info', '{}' ;
INSERT INTO public.loggers (key, "isEnabled", level, config) SELECT 'eventlog', false, 'warn', '{}' ;
INSERT INTO public.loggers (key, "isEnabled", level, config) SELECT 'loggly', false, 'warn', '{"token":"","subdomain":""}' ;
INSERT INTO public.loggers (key, "isEnabled", level, config) SELECT 'logstash', false, 'warn', '{}' ;
INSERT INTO public.loggers (key, "isEnabled", level, config) SELECT 'newrelic', false, 'warn', '{}' ;
INSERT INTO public.loggers (key, "isEnabled", level, config) SELECT 'papertrail', false, 'warn', '{"host":"","port":0}' ;
INSERT INTO public.loggers (key, "isEnabled", level, config) SELECT 'raygun', false, 'warn', '{}' ;
INSERT INTO public.loggers (key, "isEnabled", level, config) SELECT 'rollbar', false, 'warn', '{"key":""}' ;
INSERT INTO public.loggers (key, "isEnabled", level, config) SELECT 'sentry', false, 'warn', '{"key":""}' ;
INSERT INTO public.loggers (key, "isEnabled", level, config) SELECT 'syslog', false, 'warn', '{}' ;
...
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 1, '2.0.0.js', 1, '2023-02-27 08:35:07.526+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 2, '2.1.85.js', 1, '2023-02-27 08:35:07.534+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 3, '2.2.3.js', 1, '2023-02-27 08:35:07.557+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 4, '2.2.17.js', 1, '2023-02-27 08:35:07.567+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 5, '2.3.10.js', 1, '2023-02-27 08:35:07.571+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 6, '2.3.23.js', 1, '2023-02-27 08:35:07.577+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 7, '2.4.13.js', 1, '2023-02-27 08:35:07.583+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 8, '2.4.14.js', 1, '2023-02-27 08:35:07.603+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 9, '2.4.36.js', 1, '2023-02-27 08:35:07.61+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 10, '2.4.61.js', 1, '2023-02-27 08:35:07.615+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 11, '2.5.1.js', 1, '2023-02-27 08:35:07.65+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 12, '2.5.12.js', 1, '2023-02-27 08:35:07.658+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 13, '2.5.108.js', 1, '2023-02-27 08:35:07.663+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 14, '2.5.118.js', 1, '2023-02-27 08:35:07.666+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 15, '2.5.122.js', 1, '2023-02-27 08:35:07.684+00' ;
INSERT INTO public.migrations (id, name, batch, migration_time) SELECT 16, '2.5.128.js', 1, '2023-02-27 08:35:07.69+00' ;
...
INSERT INTO public.migrations_lock (index, is_locked) SELECT 1, 0 ;
...
INSERT INTO public.navigation (key, config) SELECT 'site', '[{"locale":"en","items":[{"id":"a80a7847-a1c0-4f91-b2d6-32c3abddd130","icon":"mdi-home","kind":"link","label":"Home","target":"/","targetType":"home","visibilityMode":"all","visibilityGroups":null}]}]' ;
...
-- ', '[{"title":"Header","anchor":"#header","children":[]}]', 'markdown', '2023-02-27T09:21:30.486Z', '2023-02-27T09:21:33.620Z', 'markdown', 'en', 1, 1, '{"js":"","css":""}' ;
...
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'asciidocCore', true, '{"safeMode":"server"}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'htmlAsciinema', false, '{}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'htmlBlockquotes', true, '{}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'htmlCodehighlighter', true, '{}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'htmlCore', true, '{"absoluteLinks":false,"openExternalLinkNewTab":false,"relAttributeExternalLink":"noreferrer"}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'htmlDiagram', true, '{}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'htmlImagePrefetch', false, '{}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'htmlMediaplayers', true, '{}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'htmlMermaid', true, '{}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'htmlSecurity', true, '{"safeHTML":true,"allowDrawIoUnsafe":true,"allowIFrames":false}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'htmlTabset', true, '{}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'htmlTwemoji', true, '{}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'markdownAbbr', true, '{}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'markdownCore', true, '{"allowHTML":true,"linkify":true,"linebreaks":true,"underline":false,"typographer":false,"quotes":"English"}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'markdownEmoji', true, '{}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'markdownExpandtabs', true, '{"tabWidth":4}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'markdownFootnotes', true, '{}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'markdownImsize', true, '{}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'markdownKatex', true, '{"useInline":true,"useBlocks":true}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'markdownKroki', false, '{"server":"https://kroki.io","openMarker":"```kroki","closeMarker":"```"}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'markdownMathjax', false, '{"useInline":true,"useBlocks":true}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'markdownMultiTable', false, '{"multilineEnabled":true,"headerlessEnabled":true,"rowspanEnabled":true}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'markdownPlantuml', true, '{"server":"https://plantuml.requarks.io","openMarker":"```plantuml","closeMarker":"```","imageFormat":"svg"}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'markdownSupsub', true, '{"subEnabled":true,"supEnabled":true}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'markdownTasklists', true, '{}' ;
INSERT INTO public.renderers (key, "isEnabled", config) SELECT 'openapiCore', true, '{}' ;
...
INSERT INTO public."searchEngines" (key, "isEnabled", config) SELECT 'algolia', false, '{"appId":"","apiKey":"","indexName":"wiki"}' ;
INSERT INTO public."searchEngines" (key, "isEnabled", config) SELECT 'aws', false, '{"domain":"","endpoint":"","region":"us-east-1","accessKeyId":"","secretAccessKey":"","AnalysisSchemeLang":"en"}' ;
INSERT INTO public."searchEngines" (key, "isEnabled", config) SELECT 'azure', false, '{"serviceName":"","adminKey":"","indexName":"wiki"}' ;
INSERT INTO public."searchEngines" (key, "isEnabled", config) SELECT 'db', true, '{}' ;
INSERT INTO public."searchEngines" (key, "isEnabled", config) SELECT 'elasticsearch', false, '{"apiVersion":"6.x","hosts":"","verifyTLSCertificate":true,"tlsCertPath":"","indexName":"wiki","analyzer":"simple","sniffOnStart":false,"sniffInterval":0}' ;
INSERT INTO public."searchEngines" (key, "isEnabled", config) SELECT 'manticore', false, '{}' ;
INSERT INTO public."searchEngines" (key, "isEnabled", config) SELECT 'postgres', false, '{"dictLanguage":"english"}' ;
INSERT INTO public."searchEngines" (key, "isEnabled", config) SELECT 'solr', false, '{"host":"solr","port":8983,"core":"wiki","protocol":"http"}' ;
INSERT INTO public."searchEngines" (key, "isEnabled", config) SELECT 'sphinx', false, '{}' ;
...
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'graphEndpoint', '{"v":"https://graph.requarks.io"}', '2023-02-27T08:53:15.100Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'certs', '{"jwk":{"kty":"RSA","n":"XXX","e":"AQAB"},"public":"-----BEGIN RSA PUBLIC KEY-----\nXXX\n-----END RSA PUBLIC KEY-----\n","private":"-----BEGIN RSA PRIVATE KEY-----\nXXX\n-----END RSA PRIVATE KEY-----\n"}', '2023-02-27T08:53:15.086Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'graphEndpoint', '{"v":"https://graph.requarks.io"}', '2023-02-27T08:53:15.100Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'lang', '{"code":"en","autoUpdate":true,"namespacing":false,"namespaces":[]}', '2023-02-27T08:53:15.106Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'logo', '{"hasLogo":false,"logoIsSquare":false}', '2023-02-27T08:53:15.115Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'mail', '{"senderName":"","senderEmail":"","host":"","port":465,"name":"","secure":true,"verifySSL":true,"user":"","pass":"","useDKIM":false,"dkimDomainName":"","dkimKeySelector":"","dkimPrivateKey":""}', '2023-02-27T08:53:15.123Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'sessionSecret', '{"v":"36de88f45b61a3f6019018b5cde5123eba83e092aa910eda2b124ac3e89900ec"}', '2023-02-27T08:53:15.132Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'telemetry', '{"isEnabled":false,"clientId":"88c376b2-0afd-4ab5-884d-986e92862bac"}', '2023-02-27T08:53:15.135Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'theming', '{"theme":"default","darkMode":false,"iconset":"mdi","injectCSS":"","injectHead":"","injectBody":""}', '2023-02-27T08:53:15.138Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'host', '{"v":"XXX"}', '2023-02-27T09:24:19.906Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'title', '{"v":"Wiki.js"}', '2023-02-27T09:24:19.962Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'company', '{"v":""}', '2023-02-27T09:24:19.964Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'contentLicense', '{"v":""}', '2023-02-27T09:24:19.966Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'footerOverride', '{"v":""}', '2023-02-27T09:24:19.967Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'seo', '{"description":"","robots":["index","follow"],"analyticsService":"","analyticsId":""}', '2023-02-27T09:24:19.969Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'logoUrl', '{"v":"/logo/wikijs-butterfly.svg"}', '2023-02-27T09:24:19.970Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'pageExtensions', '{"v":["md","html","txt"]}', '2023-02-27T09:24:19.972Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'auth', '{"autoLogin":true,"enforce2FA":null,"hideLocal":null,"loginBgUrl":null,"audience":"urn:wiki.js","tokenExpiration":"30m","tokenRenewal":"14d"}', '2023-02-27T09:24:19.973Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'editShortcuts', '{"editFab":true,"editMenuBar":false,"editMenuBtn":true,"editMenuExternalBtn":true,"editMenuExternalName":"GitHub","editMenuExternalIcon":"mdi-github","editMenuExternalUrl":"https://github.com/org/repo/blob/main/{filename}"}', '2023-02-27T09:24:19.976Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'features', '{"featurePageRatings":true,"featurePageComments":true,"featurePersonalWikis":true}', '2023-02-27T09:24:19.981Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'security', '{"securityOpenRedirect":true,"securityIframe":true,"securityReferrerPolicy":true,"securityTrustProxy":true,"securitySRI":true,"securityHSTS":false,"securityHSTSDuration":300,"securityCSP":false,"securityCSPDirectives":""}', '2023-02-27T09:24:19.985Z' ;
INSERT INTO public.settings (key, value, "updatedAt") SELECT 'uploads', '{"maxFileSize":5242880,"maxFiles":10,"scanSVG":true,"forceDownload":true}', '2023-02-27T09:24:19.989Z' ;
...
INSERT INTO public.storage (key, "isEnabled", mode, config, "syncInterval", state) SELECT 'azure', false, 'push', '{"accountName":"","accountKey":"","containerName":"wiki","storageTier":"Cool"}', 'P0D', '{"status":"pending","message":"","lastAttempt":null}' ;
INSERT INTO public.storage (key, "isEnabled", mode, config, "syncInterval", state) SELECT 'box', false, 'push', '{"clientId":"","clientSecret":"","rootFolder":""}', 'P0D', '{"status":"pending","message":"","lastAttempt":null}' ;
INSERT INTO public.storage (key, "isEnabled", mode, config, "syncInterval", state) SELECT 'digitalocean', false, 'push', '{"endpoint":"nyc3.digitaloceanspaces.com","bucket":"","accessKeyId":"","secretAccessKey":""}', 'P0D', '{"status":"pending","message":"","lastAttempt":null}' ;
INSERT INTO public.storage (key, "isEnabled", mode, config, "syncInterval", state) SELECT 'disk', false, 'push', '{"path":"","createDailyBackups":false}', 'P0D', '{"status":"pending","message":"","lastAttempt":null}' ;
INSERT INTO public.storage (key, "isEnabled", mode, config, "syncInterval", state) SELECT 'dropbox', false, 'push', '{"appKey":"","appSecret":""}', 'P0D', '{"status":"pending","message":"","lastAttempt":null}' ;
INSERT INTO public.storage (key, "isEnabled", mode, config, "syncInterval", state) SELECT 'gdrive', false, 'push', '{"clientId":"","clientSecret":""}', 'P0D', '{"status":"pending","message":"","lastAttempt":null}' ;
...
INSERT INTO public.storage (key, "isEnabled", mode, config, "syncInterval", state) SELECT 'onedrive', false, 'push', '{"clientId":"","clientSecret":""}', 'P0D', '{"status":"pending","message":"","lastAttempt":null}' ;
INSERT INTO public.storage (key, "isEnabled", mode, config, "syncInterval", state) SELECT 's3', false, 'push', '{"region":"","bucket":"","accessKeyId":"","secretAccessKey":""}', 'P0D', '{"status":"pending","message":"","lastAttempt":null}' ;
INSERT INTO public.storage (key, "isEnabled", mode, config, "syncInterval", state) SELECT 's3generic', false, 'push', '{"endpoint":"https://service.region.example.com","bucket":"","accessKeyId":"","secretAccessKey":"","sslEnabled":true,"s3ForcePathStyle":false,"s3BucketEndpoint":false}', 'P0D', '{"status":"pending","message":"","lastAttempt":null}' ;
INSERT INTO public.storage (key, "isEnabled", mode, config, "syncInterval", state) SELECT 'sftp', false, 'push', '{"host":"","port":22,"authMode":"privateKey","username":"","privateKey":"","passphrase":"","password":"","basePath":"/root/wiki"}', 'P0D', '{"status":"pending","message":"","lastAttempt":null}' ;
...
INSERT INTO public."userGroups" (id, "userId", "groupId") SELECT 1, 1, 1 ;
INSERT INTO public."userGroups" (id, "userId", "groupId") SELECT 2, 2, 2 ;
...
INSERT INTO public.users (id, email, name, "providerId", password, "tfaIsActive", "tfaSecret", "jobTitle", location, "pictureUrl", timezone, "isSystem", "isActive", "isVerified", "mustChangePwd", "createdAt", "updatedAt", "providerKey", "localeCode", "defaultEditor", "lastLoginAt", "dateFormat", appearance) SELECT 2, 'guest@example.com', 'Guest', NULL, '', false, NULL, '', '', NULL, 'America/New_York', true, true, true, false, '2023-02-27T08:53:15.997Z', '2023-02-27T08:53:15.997Z', 'local', 'en', 'markdown', NULL, '', '' ;

-- TODO test without admin user
INSERT INTO public.users (id, email, name, "providerId", password, "tfaIsActive", "tfaSecret", "jobTitle", location, "pictureUrl", timezone, "isSystem", "isActive", "isVerified", "mustChangePwd", "createdAt", "updatedAt", "providerKey", "localeCode", "defaultEditor", "lastLoginAt", "dateFormat", appearance) SELECT 1, 'test@1234.com', 'Administrator', NULL, 'XXXXXXXXX', false, NULL, '', '', NULL, 'America/New_York', false, true, true, false, '2023-02-27T08:53:15.422Z', '2023-02-27T08:53:15.422Z', 'local', 'en', 'markdown', '2023-02-27T09:29:07.083Z', '', '' ;
